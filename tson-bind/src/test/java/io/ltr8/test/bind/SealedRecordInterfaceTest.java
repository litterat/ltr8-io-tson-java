...
import io.ltr8.test.data.SealedRecordInterface.RecordCircle;
import io.ltr8.test.data.SealedRecordInterface.RecordPoint;
import io.ltr8.test.data.SealedRecordInterface.RecordRectangle;
import io.ltr8.test.data.SealedRecordInterface.SealedShape;
import io.ltr8.test.data.SealedRecordInterface.SealedShapeList;
...
public class SealedRecordInterfaceTest {
	...
	public void testMapToObjectException() throws Throwable {
		...
		point.put("type", "io.ltr8.test.bind.union.SealedInterfaceUnionRectangle");
