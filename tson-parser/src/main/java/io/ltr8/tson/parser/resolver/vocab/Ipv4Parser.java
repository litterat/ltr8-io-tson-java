 ...
 */
public record Ipv4Parser() implements AtomType<Inet4Address> {
    ...
    public static final Ipv4Parser UNCONSTRAINED = new Ipv4Parser();

    private static final String DEC_OCTET = "(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])";

    /**
     * Package-visible, not {@code private}: {@link Ipv6Parser} reuses this exact grammar for RFC
