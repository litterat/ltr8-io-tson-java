 ...
 * SchemaResolver} used to hold a {@code TsonCompiledRegistry} directly and simply looked things up
 ...
 * (Part 2 §1.5) and answer it directly, via {@link MetaKernelParser#parse()}'s own hand-written
 ...
 * {@link SchemaSource}, the pluggable hook {@link DefaultSchemaCoordinator} defers to for exactly
