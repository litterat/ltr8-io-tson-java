 ...
 * io.ltr8.tson.schema.meta.Top} kind. One instance is compiled per {@link TsonSchemaParser} entry
 ...
 * ParserFactoryRegistry}'s own Javadoc) would produce a result that was never meant to be written
 ...
 *            parser (unaffected by which mode is compiling, see {@link ParserFactoryRegistry}), or
 ...
 */
public interface TsonTypeParser<T> {
