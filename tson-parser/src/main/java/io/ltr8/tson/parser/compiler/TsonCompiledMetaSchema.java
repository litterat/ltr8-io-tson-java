 ...
 * compiler.TsonSchemaCompiler}'s own behavior exactly -- it always compiled every schema (meta-kernel
...
public final class TsonCompiledMetaSchema {
     ...
     */
    public TsonValueReader<?> create(String name, TypeDefinition typeDefinition, ValueReaderResolver readerResolver) {
