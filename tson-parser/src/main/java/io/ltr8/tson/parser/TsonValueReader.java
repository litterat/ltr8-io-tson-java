 ...
 * after compiling a schema (via {@link TsonCompiledSchema#get}) or reading through {@code
 * SchemaValidatingParser}. Lives at this module's own root package, alongside {@link
 * TsonDataParser}/{@link TsonSchemaParser} -- this library's other two types a consumer directly
 * names -- rather than in {@code compiler}, since a caller receives one of these directly and never
 * needs to know how it was built.
 *
 ...
 * TsonParserFactory}, {@code CompilationContext}, {@code DataNameBinder}), which this codebase has
 ...
 * yet. It isn't obviously symmetric the way {@link AtomType#write} is: a hypothetical
 ...
 *            reader (unaffected by which mode is compiling, see {@link TsonParserFactoryRegistry}), or
