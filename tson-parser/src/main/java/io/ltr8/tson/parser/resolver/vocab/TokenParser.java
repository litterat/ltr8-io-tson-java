 ...
 * SPEC-FEEDBACK.md}). {@code value} routes through {@link io.ltr8.tson.parser.resolver.BaseTypeResolver}
 * instead ({@link ValueParser}), and {@code void} accepts only the absent sentinel {@code _}, not a
 * token at all -- see {@code io.ltr8.tson.parser.resolver.schema.compiled.VoidParser}, since that
