...
import io.ltr8.tson.parser.atom.ComplexParser;
import io.ltr8.tson.parser.atom.DateParser;
import io.ltr8.tson.parser.atom.DateTimeParser;
import io.ltr8.tson.parser.atom.DecimalParser;
import io.ltr8.tson.parser.atom.DurationParser;
import io.ltr8.tson.parser.atom.EnumParser;
import io.ltr8.tson.parser.atom.FloatParser;
import io.ltr8.tson.parser.atom.IntegerParser;
import io.ltr8.tson.parser.atom.Ipv4Parser;
import io.ltr8.tson.parser.atom.Ipv6Parser;
import io.ltr8.tson.parser.atom.RationalParser;
import io.ltr8.tson.parser.atom.RegexParser;
import io.ltr8.tson.parser.atom.TextParser;
import io.ltr8.tson.parser.atom.TimeParser;
import io.ltr8.tson.parser.atom.TokenParser;
import io.ltr8.tson.parser.atom.UriParser;
import io.ltr8.tson.parser.atom.UuidParser;
 ...
 * of {@code compiler.AtomTypeParser}, not a reuse of it. Deliberately duplicated rather than shared:
 * {@code compiler.TsonParserFactoryRegistry} is going away and some of these classes may move again
 * before this package settles, so everything it needs stays self-contained here in the meantime
 * rather than reaching back into {@code compiler}.
 *
