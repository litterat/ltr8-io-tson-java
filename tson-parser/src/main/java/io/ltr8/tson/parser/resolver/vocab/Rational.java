 ...
 * negative or zero denominator; any sign belongs to the numerator).
 *
 ...
 * BigFraction}), and currently the *only* fit, full stop. This class stays in {@code tson-parser},
 * which has no dependency on {@code tson-bind} at all -- see {@link RationalType}'s Javadoc.
 */
