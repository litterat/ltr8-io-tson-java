 ...
 * counterpart to {@code compiler.VariantParser}. That class dispatches by {@code !typeName} over
 ...
 * compiler.RecordParser}: a caller with an *independently designed* Java sealed interface (not
 ...
 * any composed kind with real subtypes, not just records ({@code compiler.VariantParser} handles
 ...
 *
 * <p><b>Preserves {@code compiler.VariantParser}'s own "own body is a valid reading too" rule</b> --
...
final class VariantBindReader implements TsonValueReader<Object> {
    ...
    private final ValueReaderResolver resolver;
