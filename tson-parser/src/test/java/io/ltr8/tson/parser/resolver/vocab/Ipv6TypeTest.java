...
class Ipv6TypeTest {
    ...
    void acceptsMidAddressCompression() throws UnknownHostException {
        assertEquals(literal("20010db8000000000000000000000001"),
                Ipv6Type.UNCONSTRAINED.read(token("2001:db8::1")));
    }
    ...
    void acceptsCompressionRepresentingExactlyOneGroup() throws UnknownHostException {
        assertEquals(literal("00010002000000040005000600070008"),
                Ipv6Type.UNCONSTRAINED.read(token("1:2::4:5:6:7:8")));
    }
    ...
    void acceptsLeadingZerosWithinAHexGroup() throws UnknownHostException {
        ...
        assertEquals(literal("00000000000000000000000000000001"),
                Ipv6Type.UNCONSTRAINED.read(token("0000:0000:0000:0000:0000:0000:0000:0001")));
    }

    @Test
    void acceptsIpv4MappedForm() throws UnknownHostException {
        assertEquals(literal("00000000000000000000ffffc0000201"),
                Ipv6Type.UNCONSTRAINED.read(token("::ffff:192.0.2.1")));
    }
    ...
    void ipv4MappedFormStillReturnsInet6AddressNotInet4Address() {
        ...
        assertInstanceOf(Inet6Address.class, Ipv6Type.UNCONSTRAINED.read(token("::ffff:192.0.2.1")));
    }
    ...
    void acceptsIpv4TailFormWithoutCompression() throws UnknownHostException {
        assertEquals(literal("00010002000300040005000601020304"),
                Ipv6Type.UNCONSTRAINED.read(token("1:2:3:4:5:6:1.2.3.4")));
    }

    @Test
    void rejectsMoreThanOneCompressionRun() {
        assertThrows(AtomParseException.class, () -> Ipv6Type.UNCONSTRAINED.read(token("1::2::3")));
        assertThrows(AtomParseException.class, () -> Ipv6Type.UNCONSTRAINED.read(token("1:::2")));
    }

    @Test
    void rejectsTooFewGroupsWithoutCompression() {
        assertThrows(AtomParseException.class, () -> Ipv6Type.UNCONSTRAINED.read(token("1:2:3:4:5:6:7")));
    }

    @Test
    void rejectsTooManyGroups() {
        assertThrows(AtomParseException.class, () -> Ipv6Type.UNCONSTRAINED.read(token("1:2:3:4:5:6:7:8:9")));
        assertThrows(AtomParseException.class, () -> Ipv6Type.UNCONSTRAINED.read(token("1:2:3:4:5:6:7::8")));
    }

    @Test
    void rejectsGroupWithTooManyHexDigits() {
        assertThrows(AtomParseException.class, () -> Ipv6Type.UNCONSTRAINED.read(token("12345::")));
    }

    @Test
    void rejectsIpv4TailNotAtTheEnd() {
        assertThrows(AtomParseException.class, () -> Ipv6Type.UNCONSTRAINED.read(token("1.2.3.4::5")));
    }

    @Test
    void rejectsIpv4TailWithLeadingZero() {
        // Same RFC 3986 dec-octet strictness as Ipv4Type itself, reused here.
        assertThrows(AtomParseException.class, () -> Ipv6Type.UNCONSTRAINED.read(token("::ffff:192.0.02.1")));
    }

    @Test
    void rejectsZoneIdentifier() {
        // core.tn1: zone identifiers are host-local and excluded from the contract.
        assertThrows(AtomParseException.class, () -> Ipv6Type.UNCONSTRAINED.read(token("fe80::1%eth0")));
    }

    @Test
    void rejectsEmptyToken() {
        assertThrows(AtomParseException.class, () -> Ipv6Type.UNCONSTRAINED.read(token("")));
    }
