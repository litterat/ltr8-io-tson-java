 ...
 * (e.g. {@code io.ltr8.tson.compiler.mapper} binding to a field declared {@code int}) and wants it directly, without
 ...
 * io.ltr8.tson.compiler.base.NumberNarrowing} with {@code io.ltr8.tson.compiler.mapper}'s untyped-number binding
