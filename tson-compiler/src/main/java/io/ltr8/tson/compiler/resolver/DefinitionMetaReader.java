 ...
 * refinement value against its own constructor's compiled compiler -- {@code type} is the constructor
 ...
 * {@link DefinitionResolver} has no dependency on {@code compiler} at all; a caller
