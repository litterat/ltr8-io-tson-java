 ...
 * {@code !!meta} is a <em>schema</em> document, which this compiler does not support — a Class 1
 * processor rejects it with a categorized diagnostic (§1.5, §8.1) rather than producing a
 * {@code Document}; see {@code io.ltr8.tson.compiler.TsonUnsupportedDocumentException}.
 *
