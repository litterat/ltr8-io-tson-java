...
/**
 * A stand-in {@link TsonValueReader} for a constructor with no compiled compiler implemented yet --
...
final class ErrorReader implements TsonValueReader<Object> {
    ...
    public Object read(DataValue value) {
        throw new UnsupportedOperationException("'" + name + "' has no usable compiled compiler -- "
