...
/**
 * Decode logic for {@link BytesParser}'s {@code BASE64}/{@code BASE64URL} encodings -- both use
 * {@link java.util.Base64}'s {@code Decoder} directly, differing only in which alphabet's decoder
 * {@link BytesParser} passes in, so the one real decision (padding strictness) lives here once.
 *
