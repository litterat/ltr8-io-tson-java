 ...
 * {@code spec/tson-rev33-changelog.md} #41/#42's position -- a repeated key states an entry for nothing, which needs
 ...
 * textual identity where the two disagree -- {@code spec/tson-rev33-changelog.md} #43 has the argument.
 *
