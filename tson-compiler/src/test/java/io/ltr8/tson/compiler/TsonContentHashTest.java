...
class TsonContentHashTest {
    ...
    void hashesEveryByteAfterTheFirstLineTerminator() {
        assertEquals(SHA_ABC, TsonContentHash.sha256(utf8("!!id:\"x\"\nabc")));
    }

    @Test
    void anEmptyBodyHashesToTheEmptyDigest() {
        assertEquals(SHA_EMPTY, TsonContentHash.sha256(utf8("!!id:\"x\"\n")));
    }
    ...
    void aLoneCrTerminatesTheFirstLineToo() {
        assertEquals(SHA_ABC, TsonContentHash.sha256(utf8("!!id:\"x\"\rabc")));
    }
    ...
    void theIdLineContentDoesNotAffectTheHash() {
        ...
        assertEquals(TsonContentHash.sha256(utf8("!!id:\"a\"\nbody")),
                TsonContentHash.sha256(utf8("!!id:\"b?sha256=deadbeef\"\nbody")));
    }

    @Test
    void contentStartPointsPastTheFirstLine() {
        assertEquals(9, TsonContentHash.contentStart(utf8("!!id:\"x\"\nabc")));   // "!!id:\"x\"\n" is 9 bytes
        assertEquals(12, TsonContentHash.contentStart(utf8("\uFEFF!!id:\"x\"\nabc")));   // + 3-byte BOM
    }

    @Test
    void noTerminatorAfterTheFirstLineThrows() {
        assertThrows(IllegalArgumentException.class, () -> TsonContentHash.sha256(utf8("!!id:\"x\"")));
    }
    ...
    void declaredSha256RejectsAnUnrecognizedQueryParameter() {
        assertThrows(IllegalArgumentException.class, () -> TsonContentHash.declaredSha256("https://x/s.tn?md5=abc"));
    }

    @Test
    void declaredSha256RejectsAMalformedPin() {
        assertThrows(IllegalArgumentException.class, () -> TsonContentHash.declaredSha256("https://x/s.tn?sha256=tooshort"));
        assertThrows(IllegalArgumentException.class,   // uppercase is not full lowercase hex
                () -> TsonContentHash.declaredSha256("https://x/s.tn?sha256=" + "A".repeat(64)));
    }
    ...
    void verifyIsANoOpForAnUnpinnedReference() {
        TsonContentHash.verify(utf8("!!id:\"x\"\nabc"), "https://x/s.tn");   // no throw
    }
}
