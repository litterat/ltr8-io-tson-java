 ...
 * AtomSpecification} or a {@link java.net.URI} and why {@code within}/{@code excluding} are bare
 * {@code List<String>} with a defensive compact constructor. {@code tson-compiler}'s {@code
