 ...
 * single Java class across several built-in annotation names the way that one does. {@link
 * BytesType.Encoding} is the third of these plain nested enums and is mirrored the same way.
 */
