 ...
 * class so far does). This is what widened {@code SchemaResolver}'s own {@code Instance} resolution
 ...
 * constructor," flagged as "a one-word change if it's ever needed") -- see {@code SchemaResolver}'s
