 ...
 * JsonValueReaderFactoryRegistry} dispatches to, keyed by the entry's resolved body's constructor name
 ...
 */
public interface JsonValueReaderFactory {

    JsonTypeReader<?> create(String name, TypeDefinition typeDefinition, JsonValueReaderContext context);
}
