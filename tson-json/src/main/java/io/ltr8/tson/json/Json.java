...
public final class Json {
    ...
    /** Over a default bind context and the processor's default policy, raising what it refuses. */
    public static Json standard() {
        return new Json(DataBindContext.builder().build(), ProcessorPolicy.defaults(),
