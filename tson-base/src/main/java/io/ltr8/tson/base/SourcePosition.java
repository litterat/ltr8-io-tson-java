...
/**
 * Where in some original source text a {@code TypeDefinition} (or other resolved value) was
 ...
 * satisfies. Unlike {@code Token}, no field-by-field conversion is needed anywhere: once {@code
