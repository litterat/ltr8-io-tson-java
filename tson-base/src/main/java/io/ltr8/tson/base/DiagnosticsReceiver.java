 ...
 *
 * <p><b>A push sink, deliberately.</b> {@code TsonReadContext} builds each {@link Diagnostic} from the path and
 ...
 * continue, so every problem surfaces; the read then returns no value ({@link CountingReceiver}).
 *
