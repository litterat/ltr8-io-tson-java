 ...
 * declared names, all three resolving to the identical empty body. This is the {@code identifier} branch;
 * the other two belong to the encoding rather than to this vocabulary -- {@code value} is read by base type
 * resolution, which depends on the lexical form, and {@code void} accepts only the absent sentinel.
 */
